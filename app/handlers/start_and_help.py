...
Просто напиши мне - /login [логин] [пароль] (параметры опциональны)
Если же ты не зарегистрирован на сайте проектного офиса, напиши мне - /register
В случае, если вы боитесь утечки персональных данных - есть вариант альтернативной авторизации /altlogin
...
Так же ты можешь узнать расписание - просто напиши мне /schedule [группа/преподаватель/аудитория] 
(<i>без аргументов будет выведено расписание вашей группы, указанной в профиле</i>)
